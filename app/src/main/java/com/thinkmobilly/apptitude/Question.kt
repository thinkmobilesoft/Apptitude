...
class Question : AppCompatActivity() {
    ...
    private fun startQuiz() {
        ...
        val totalnum: TextView = findViewById(R.id.total_num)
        val mainqestion: TextView = findViewById(R.id.main_question)
        val donelayout: ConstraintLayout = findViewById(R.id.done)
        ...
        mainqestion.text = currentQuestion
        ...
        answerListView.setOnItemClickListener { parent, view, position, id ->
            ...
            totalnum.text = "${questionNum.toString()}/${allJoined[0].questions.count()}"
            mainqestion.text = allJoined[0].questions[questionNr]
